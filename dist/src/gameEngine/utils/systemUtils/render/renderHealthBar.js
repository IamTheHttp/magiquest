...
function renderHealthBar(systemArguments, entity) {
    ...
    var healthWidth = entity[POSITION_COMP].width || entity[POSITION_COMP].radius * 2 || 200;
    var healthMargin = entity[POSITION_COMP].height || entity[POSITION_COMP].radius * 1 + 2 || 200;
    var healthHeight = 2;
