...
import {CANVAS_OUTPUT, CIRCLE_SHAPE, HEALTH_BAR_SHAPE, PLAYER_CHAR} from 'gameEngine/gameConstants';
...
class Sentry extends BaseEntity {
  constructor({col, row, radius = 16, vision = 200, speed = 0.5, health = 100, dmg = 1}: ISentryConstructor) {
    super(Sentry);
